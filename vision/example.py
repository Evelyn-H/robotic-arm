...
def brute_force_feature_matcher(kp1, des1, kp2, des2):
    ...
    #                    flags = 2)
    #
    # global frame, img_object
    # frame = cv2.drawMatches(img_object,kp1,frame,kp2,matches,None,**draw_params)
    #
...
def put_position_orientation_value_to_frame(translation, rotation):
    ...
    cv2.putText(frame,'x:'+str(round(rotation[0][0],2)),(250,60), font, 0.7,(0,0,255),2,cv2.LINE_AA)
    cv2.putText(frame,'y:'+str(round(rotation[1][0],2)),(350,60), font, 0.7,(0,0,255),2,cv2.LINE_AA)
    cv2.putText(frame,'z:'+str(round(rotation[2][0],2)),(450,60), font, 0.7,(0,0,255),2,cv2.LINE_AA)
...
kinect_intrinsic_param = np.array(
    [[1.21590122e+03, 0.00000000e+00, 3.75456517e+02],
     [0.00000000e+00, 1.17248719e+03, 3.56379910e+02],
     [0.00000000e+00, 0.00000000e+00, 1.00000000e+00]]
)
kinect_distortion_param = np.array([[0.11245815, 0.30009981, 0.0081315, -0.03802704, -0.6149271]])
...
while True:
    ...
    if k == ord('i'):
        ...
        img_object = cv2.imread('images/qrblur.png',0)
        track_mode = True
    ...
    if track_mode is True:
        ...
        print(object_points_3d, corner_camera_coord)
